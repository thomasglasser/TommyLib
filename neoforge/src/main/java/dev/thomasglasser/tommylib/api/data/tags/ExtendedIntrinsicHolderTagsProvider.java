...
public abstract class ExtendedIntrinsicHolderTagsProvider<T> extends IntrinsicHolderTagsProvider<T> {
    ...
    public ExtendedIntrinsicHolderTagsProvider(PackOutput output, ResourceKey<? extends Registry<T>> registryKey, CompletableFuture<HolderLookup.Provider> lookupProvider, Function<T, ResourceKey<T>> keyExtractor, String modId, @Nullable ExistingFileHelper existingFileHelper) {

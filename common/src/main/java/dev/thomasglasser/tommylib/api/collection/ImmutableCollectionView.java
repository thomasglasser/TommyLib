...
/**
 * An unmodifiable view of a backing {@link Collection}.
 *
...
public record ImmutableCollectionView<E>(Collection<E> delegate) implements Collection<E> {
     ...
     * @param <E>      The element type
     * @return An {@link ImmutableCollectionView} wrapping the delegate
     */
    ...
    /**
     * Returns an empty {@link ImmutableCollectionView}.
     *
     * @param <E> The element type

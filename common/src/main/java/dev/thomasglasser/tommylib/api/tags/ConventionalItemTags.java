...
public final class ConventionalItemTags {
	...
	/**
	 * Tag that holds all items that's block form is unbreakable.
	 */
	...
	{
		return switch (color) {
			case BLACK -> BLACK_DYES;
			case BLUE -> BLUE_DYES;
			case BROWN -> BROWN_DYES;
			case CYAN -> CYAN_DYES;
			case GRAY -> GRAY_DYES;
			case GREEN -> GREEN_DYES;
			case LIGHT_BLUE -> LIGHT_BLUE_DYES;
			case LIGHT_GRAY -> LIGHT_GRAY_DYES;
			case LIME -> LIME_DYES;
			case MAGENTA -> MAGENTA_DYES;
			case ORANGE -> ORANGE_DYES;
			case PINK -> PINK_DYES;
			case PURPLE -> PURPLE_DYES;
			case RED -> RED_DYES;
			case WHITE -> WHITE_DYES;
			case YELLOW -> YELLOW_DYES;
		};
	}
}
